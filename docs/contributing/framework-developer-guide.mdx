...
- `scripts`: Contains python scripts to build the client and to manage the python scripts. Also contains bash scripts to update the client and to build res.neu for the test the test app.
...
- `scripts`: Python script to manage release notes.
